...
python src/hypergol/cli/create_data_model.py --projectDirectory=example Sentence startChar:int endChar:int articleId:int:id sentenceId:int:id "tokens:List[Token]" && \
...
python src/hypergol/cli/create_data_model.py --projectDirectory=example ArticleText articleTextId:int:id publishDate:datetime title:str text:str url:str && \
