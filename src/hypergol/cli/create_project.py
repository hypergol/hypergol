...
def create_project(projectName, dryrun=None, force=None):
    ...
    project.create_tensorflow_model_directory()
    project.render_simple(templateName='__init__.py.j2', filePath=Path(project.tensorflowModelsPath, '__init__.py'))
    project.create_tensorflow_model_blocks_directory()
    project.render_simple(templateName='__init__.py.j2', filePath=Path(project.tensorflowModelBlocksPath, '__init__.py'))
